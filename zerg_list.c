...
vertex *
insertVertex (vertex * front, int id, double lon, double lat, float alt)
{
...
edge *
insertEdge (edge * front, int id, double weight, vertex * parent)
{
...
double
pythagorean (float alt1, float alt2, double haversine)
{
...
bool
sameConnections (vertex * zergNode)
{
  bool goodGraph = true;
  vertex *cursor = zergNode;
  int graphConn;
...
void
adjAdjust (vertex * zergNode, int adjId)
{
  vertex *cursor;
  edge *adjacencyIndex;
